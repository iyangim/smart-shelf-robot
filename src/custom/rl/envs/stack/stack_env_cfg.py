# -*- coding: utf-8 -*-
# Task 3: Stacking — MDP 환경 기반 설정
# ~/smart-shelf-robot/src/custom/rl/envs/stack/stack_env_cfg.py
...
class ObjectTableSceneCfg(InteractiveSceneCfg):
    ...
    This is the base implementation. The derived class sets the specific robot, ee_frame, and cubes.
    """

    # robots: populated by agent env cfg
    robot: ArticulationCfg = MISSING
    # end-effector sensor: populated by agent env cfg
    ee_frame: FrameTransformerCfg = MISSING

    # Table
    table = AssetBaseCfg(
        prim_path="{ENV_REGEX_NS}/Table",
        init_state=AssetBaseCfg.InitialStateCfg(pos=[0.5, 0.0, -0.05], rot=[1.0, 0.0, 0.0, 0.0]),
        spawn=UsdFileCfg(
            usd_path=f"{ISAAC_NUCLEUS_DIR}/Props/Mounts/SeattleLabTable/table_instanceable.usd",
            scale=(0.7, 0.7, 0.7)  # 약간 크기 조절
        ),
    )
...
class RewardsCfg:
    ...
    # Stage 3: Align cubes for stacking
